...
# set other tile server (standard is OpenStreetMap) map_widget.set_tile_server(
# "https://mt0.google.com/vt/lyrs=m&hl=en&x={x}&y={y}&z={z}&s=Ga", max_zoom=22)  # google normal
# map_widget.set_tile_server("https://mt0.google.com/vt/lyrs=s&hl=en&x={x}&y={y}&z={z}&s=Ga", max_zoom=22)  # google
# satellite

# set current position and zoom
map_widget.set_position(55.9496, 37.5018, marker=False)
...
marker_3 = map_widget.set_marker(55.9496, 37.5018, text="Dolgoprudny")
# marker_3.set_position(...)
# marker_3.set_text(...)
# marker_3.delete()

# set a path
path_1 = map_widget.set_path([marker_3.position, (55.9496, 37.5018)])
# path_1.add_position(...)
